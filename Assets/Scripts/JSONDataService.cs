...
{
    private const string KEY = "3rjNywhoSUcQn7jX3rqMjU26KDguPswObmh+CoohzAs=";
    private const string IV = "JgeibYIz9ZM5xDjmMUUpvQ==";
    ...
    private void WriteEncryptedData<T>(T Data, FileStream Stream)
    {
        ...
        /* Use if needed to generate new IV/Key
