...
public class Demo : MonoBehaviour
{
    ...
    public void SerializeJson()
    {
        ...
        if (DataService.SaveData("/player-stats.json", ProfileData, EncryptionEnabled))
        {
            ...
            try
            {
                ProfileData data = DataService.LoadData<ProfileData>("/player-stats.json", EncryptionEnabled);
    ...
    private void Awake()
    {
        SourceDataText.SetText(JsonConvert.SerializeObject(ProfileData, Formatting.Indented));
    }
